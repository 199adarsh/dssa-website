...
let gameState = {
  ...
  questions: [],
  correctAnswers: 0,
  selectedLevel: null, // 'emoji' for emoji challenge
...
const emojiQuestions = [
  {
    id: 1,
    question: "The latest generation of mobile networks 📡 📶",
    emojis: ["📡", "📶"],
    answer: "5G",
    hints: [
      "Faster than 4G",
      "Used for IoT and smart cities",
      "Name has a single digit",
    ],
  },
  {
    id: 2,
    question: "A branch of AI represented by ⚙ 📚",
    emojis: ["⚙", "📚"],
    answer: "Machine Learning",
    hints: [
      "Learns from data",
      "Subset of Artificial Intelligence",
      "Drives recommendations on Netflix",
    ],
  },
  {
    id: 3,
    question: "The study of computers 💻 🔬 📈",
    emojis: ["💻", "🔬", "📈"],
    answer: "Computer Science",
    hints: [
      "Taught in universities",
      "Includes algorithms and coding",
      "Abbreviated as CS",
    ],
  },
  {
    id: 4,
    question: "A language with a reptile symbol 🐍 👨‍💻",
    emojis: ["🐍", "👨‍💻"],
    answer: "Python",
    hints: [
      "Very popular in Data Science",
      "Named after a snake",
      "Has packages like NumPy and Pandas",
    ],
  },
  {
    id: 5,
    question: "Analyzing and extracting insights 🗄 📊 🧠",
    emojis: ["🗄", "📊", "🧠"],
    answer: "Data Science",
    hints: [
      "Big field in tech industry",
      "Involves statistics + coding",
      "Commonly abbreviated as DS",
    ],
  },
  {
    id: 6,
    question: "Brain-inspired computing 🧠 🔗",
    emojis: ["🧠", "🔗"],
    answer: "Neural Network",
    hints: [
      "Artificial neurons",
      "Used in Deep Learning",
      "Word contains 'Network'",
    ],
  },
  {
    id: 7,
    question: "Smart machines 🤖 💡",
    emojis: ["🤖", "💡"],
    answer: "Artificial Intelligence",
    hints: [
      "Field of computer science",
      "Simulates human intelligence",
      "Common abbreviation: AI",
    ],
  },
  {
    id: 8,
    question: "Massive information ☁️ 🖥 💥",
    emojis: ["☁️", "🖥", "💥"],
    answer: "Big Data",
    hints: [
      "Too large for normal databases",
      "Analyzed using Hadoop or Spark",
      "Two words: Big ___",
    ],
  },
  {
    ...
    emojis: ["☕", "💻"],
    answer: "Java",
    hints: ["Named after coffee", "Runs on JVM", "Used for Android apps"],
  },
  {
    id: 10,
    question: "Storing files online ☁️ 📱",
    emojis: ["☁️", "📱"],
  ...
  {
    id: 11,
    question: "Technology behind Bitcoin 🔗 📜",
    emojis: ["🔗", "📜"],
    answer: "Blockchain",
    hints: [
  ...
  {
    id: 12,
    question: "Protecting systems from hackers 🛡️ 💻",
    emojis: ["🛡️", "💻"],
    answer: "Cybersecurity",
    hints: [
      "Involves firewalls & antivirus",
      "Digital defense",
      "Two words: Cyber ___",
    ],
  },
  {
    id: 13,
    question: "Immersive digital experience 🎮 🕶️",
    emojis: ["🎮", "🕶️"],
    answer: "Virtual Reality",
    hints: ["Uses a headset", "Creates 3D worlds", "Two words: Virtual ___"],
  },
  {
    id: 14,
    question: "Mix of real and digital world 🌍 🕶️",
    emojis: ["🌍", "🕶️"],
    answer: "Augmented Reality",
    hints: [
      "Pokemon Go uses it",
      "Overlay of graphics in real life",
      "Two words: Augmented ___",
    ],
  },
  {
    id: 15,
    question: "Worldwide network 🌐 🔍",
    emojis: ["🌐", "🔍"],
    answer: "Internet",
    hints: [
  ...
  {
    id: 16,
    question: "Data stored in tables 📊 🗄️",
    emojis: ["📊", "🗄️"],
    answer: "Database",
    hints: ["Structured storage", "Uses SQL", "Short for Relational DB"],
  },
  {
    id: 17,
    question: "Open-source OS 🐧 💻",
    emojis: ["🐧", "💻"],
    answer: "Linux",
    hints: [
      "Mascot is a penguin",
      "Used in servers",
      "Popular distros: Ubuntu, Fedora",
    ],
  },
  {
    id: 18,
    question: "Front-end language 🌐 🎨",
    emojis: ["🌐", "🎨"],
    answer: "CSS",
    hints: ["Used for styling web pages", "Works with HTML", "Acronym: CSS"],
  },
  {
    id: 19,
    question: "Markup for the web 🌐 📝",
    emojis: ["🌐", "📝"],
    answer: "HTML",
    hints: [
      "Standard for web pages",
      "Defines structure with tags",
      "Abbreviation: HTML",
    ],
  },
  {
    id: 20,
    question: "Backend scripting language ⚡ 💻",
    emojis: ["⚡", "💻"],
    answer: "JavaScript",
    hints: [
...
function viewLeaderboardAsGuest() {
  ...
  // DISABLED FOR TESTING - Skip attempt restriction for guests
  // loadAttemptStatus();
  // const restriction = checkAttemptRestriction();
  // if (!restriction.allowed) {
  //   showAttemptRestriction();
  ...
  // Hide getAuth() section and show leaderboard
...
function selectLevel(level) {
  ...
  // Update game state for emoji game
  gameState.totalQuestions = 10;
  gameState.maxHints = 3;
  gameState.hintsUsed = 0;
  gameState.timeLeft = 15;

  // Use the predefined emoji questions
  console.log("=== selectLevel() debugging ===");
  console.log("Level:", level);
  console.log("Emoji questions available:", emojiQuestions.length);

  const shuffledQuestions = [...emojiQuestions].sort(() => Math.random() - 0.5);
  gameState.questions = shuffledQuestions.slice(0, 10);
  ...
  if (levelBadge) {
    levelBadge.textContent = "🎯 Emoji Challenge";
    levelBadge.style.background = "linear-gradient(135deg, #3b82f6, #2563eb)";
  }
...
function showQuestion() {
  ...
  // Display question text and emoji clues
  if (question.emojis && question.emojis.length > 0) {
    const emojiDisplay = question.emojis
      .map((emoji) => `<span class="emoji-clue">${emoji}</span>`)
      .join(" ");
  ...
  // Reset timer to 15 seconds for emoji game
  gameState.timeLeft = 15;
  updateTimerDisplay();
...
function submitAnswer() {
  ...
  if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
    ...
    const basePoints = 1;
    const speedBonus =
      gameState.timeLeft > 10 ? 0.5 : gameState.timeLeft > 5 ? 1 : 0;
    const points = basePoints + timeBonus + speedBonus;
    ...
    const brutalMessages = [
      ...
      `🔥 Try again! Answer: ${correctAnswer}`,
      `🤡 Not quite! The correct answer: ${correctAnswer}`,
      `💥 Missed it! It's: ${correctAnswer}`,
    ];
    const randomMessage =
    ...
    console.log("Incorrect answer - scheduling nextQuestion in 3 seconds");
    setTimeout(() => {
...
function updateUI() {
  ...
  if (gameState.gameEnded) {
    elements.playerStatus.classList.add("done");
    elements.playerStatus.innerHTML =
      '<span class="status-icon">✅</span><span class="status-text">Done</span>';
  } else if (gameState.gameStarted) {
    elements.playerStatus.classList.add("guessing");
    elements.playerStatus.innerHTML =
      '<span class="status-icon">🔴</span><span class="status-text">Guessing</span>';
  } else {
...
function updateScore() {
  ...
  // Add visual feegetDB()ack for score update
...
function showFeedback(message, type) {
  ...
  elements.feedback.innerHTML = `<div class="feegetDB()ack-content">${sanitizedMessage}</div>`;
  elements.feedback.className = `feegetDB()ack-area ${type}`;
...
function setupGameControls() {
  ...
  if (gameControlsSetup) {
    console.log("Game controls already set up, skipping...");
    return;
  }
  ...
  // Setup submit button with debouncing
  if (submitBtn) {
  ...
  // Setup answer box
  if (answerBox) {
    answerBox.removeEventListener("keypress", handleAnswerKeypress);
    answerBox.addEventListener("keypress", handleAnswerKeypress);
    console.log("Answer box listener added");
  }

  // Update cached elements
  elements.submitBtn = submitBtn;
  elements.hintBtn = hintBtn;
  elements.answerBox = answerBox;
